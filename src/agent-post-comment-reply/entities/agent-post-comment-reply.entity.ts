...
@Schema()
export class AgentPostCommentReply {
  @ApiProperty({
  ...
  @Prop({ type: mongoose.Schema.Types.ObjectId, ref: 'AgentPostComment' })
...
export const AgentPostCommentReplySchema = SchemaFactory.createForClass(AgentPostCommentReply);
